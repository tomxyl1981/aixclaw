...
### 那耶村机制设计方案（2026-05-27新增）

详见：`files/naye-village-mechanism-design.md`

**理论依据**：Maskin机制设计理论 + 纳什博弈论

**三方博弈**：
- 投资人（资金）：年化回报率≥15%
- 操盘人（运营）：5年分成≥初始投资×3
- 村集体（土地）：持续Coin Hour产出 + 土地增值

**三种方案**：
- A：分阶段让渡机制（Phase 1→2→3）
- B：Token化治理（Token锁定+Coin Hour产出）
- C：可验证业绩机制（财务透明+里程碑奖励）

**关键约束**：
- AIX已在L Bank/Bitmart上市，Token可自由交易
- Coin Hour产出绑定DID（村民身份），而非Token
- 村民可套现但仍保留基础产出权

---

*更新时间: 2026-05-27 | 新增那耶村机制设计方案*


### Coin Hour内循环设计（2026-05-27新增）

**核心理念**：服务即挖矿

**流程**：
```
村民需求 → AIX Claw收集 → 代买人代买 → 集装箱超市上架
→ 村民付Coin Hour → 代买人获得AIX Token奖励 → 循环
```

**激励设计**：
- 代买人：代买物品 → 获得 AIX Token奖励
- AIX Token → 每日产出Coin Hour → 长期收益
- 村民：持有AIX → 产出Coin Hour → 消费换物品

**奖励来源建议**：
- 村民消费时，10% Coin Hour进入奖励池
- 奖励池购买AIX → 奖励代买人
- 消费支撑奖励，循环自平衡

---

*更新时间: 2026-05-27 | 新增Coin Hour内循环设计*


### MiniMind项目分析（2026-05-27新增）

详见：`knowledge/minimind-analysis.md`

**项目**：GitHub - jingyaogong/minimind（50,466星）
**核心能力**：2小时从零训练64M参数LLM，成本¥3

**对AIX的帮助**：
1. AIX Box本地推理（64M模型，0.5GB内存）
2. 那耶村专属模型训练（梁越IP+本地文化）
3. AIX Claw定制（理解村民需求）
4. 夏令营教学内容（¥5/人训练成本）
5. 漫剧创作辅助（本地推理+数据主权）

**技术架构建议**：
- 简单任务 → MiniMind on AIX Box
- 中等任务 → 7B on Mac mini
- 复杂任务 → DeepSeek API

---

*更新时间: 2026-05-27 | 新增MiniMind项目分析*


### 那耶三生福地（2026-05-27新增）

详见：`knowledge/naye-three-lives-blessed-land.md`
