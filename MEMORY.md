...
### "那"文化博物园概念性方案（2026-05-27新增）

详见：`knowledge/naye-cultural-museum-concept-plan.md`

**核心定位**：活态的世界稻作文明原乡・跨域的文化共生枢纽

**空间布局**：
- 一心：那文化博物馆 + 图腾文化广场
- 四区：那脉（种质繁育）+ 那艺（非遗传承）+ 那耕（农事体验）+ 那飨（林牧融合）
- 双带：文化寻踪带 + 生态体验带
- 全域沉浸：《鱼鳞图册》演艺 + 五感体验

**非遗活态传承区（5大主题馆）**：
- 那器人家、那锦绣坊、那油老榨坊、那糖甜蜜屋、那膳厨房

**实施阶段**：
- 2026-2027：筹备（合作社注册、博物馆建设）
- 2027-2028：建设（四区建设、跨境合作）
- 2028-2030：运营（全面开放、国际论坛）

**与AIX契合**：
- Coin Hour：门票、体验、文创、民宿、餐饮
- 数字化：寻那密码小程序、AR/VR、数字孪生
- AIX Box部署：游客中心、非遗区、农事体验区

---

*更新时间: 2026-05-27 | 新增"那"文化博物园方案*
